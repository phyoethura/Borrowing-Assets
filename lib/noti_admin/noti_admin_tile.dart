...
class Noti_Tile extends StatelessWidget {
  //var ImageAsset;
  //var assetImage;
  var customerName;
  var assetName;
  ...
  Noti_Tile( this.assetName, this.customerName, this.index);
    ...
    return GridTile(
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Expanded(child: Text(' $assetName has been requested by $customerName.')),
               IconButton(
