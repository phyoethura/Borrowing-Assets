...
class Asset_Admin extends StatefulWidget {
  const Asset_Admin({super.key});

  @override
  State<Asset_Admin> createState() => _Asset_AdminState();
}

class _Asset_AdminState extends State<Asset_Admin> {
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                          color: Color.fromARGB(255, 110, 247, 114)),
                      child: Text(
                        ' Available ',
